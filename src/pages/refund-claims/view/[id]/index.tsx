...
import { getRefundClaimById } from 'apiSdk/refund-claims';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Refund Claim Detail View
          </Text>
          {hasAccess('refund_claim', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/refund-claims/edit/${data?.id}`} passHref legacyBehavior>
              <Button
